...
class PublisherUI(QWidget):
    ...
    def _apply_i18n_library(self, payload: dict) -> None:
        if not isinstance(payload, dict):
            return
        self.i18n_library = payload
        room_name_i18n = payload.get("room_name_i18n", {})
        room_name_en = room_name_i18n.get("en") if isinstance(room_name_i18n, dict) else None
        if room_name_en:
