...
- `livekit_track_not_published_yet` — selected channel есть, но track ещё не опубликован; worker остаётся подключённым и ждёт, это не автоматический VPS failure.
